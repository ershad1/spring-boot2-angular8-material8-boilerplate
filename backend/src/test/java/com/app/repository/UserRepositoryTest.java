...
public class UserRepositoryTest extends BaseRepositoryTest {
    ...
    public void findByIdTest() {
        ...
        User fetchedUser = userRepository.getOne(user.getId());
    ...
    public void existsTest() {
        assertTrue("User should exists", userRepository.existsById(1001L));
        assertFalse("User shouldn't exists", userRepository.existsById(Long.MAX_VALUE));
    }
    ...
    public void changeUsernameTest() {
        User user = userRepository.getOne(1001L);
        user.setUsername("another random name");
        User changedUser = userRepository.getOne(1001L);
    ...
    public void deleteTest() {
        ...
        assertFalse("User with id 1001 should not exists", userRepository.existsById(1001L));
    }
